<template>
    <div :class="[
        ...
        <div :class="[
            ...
            <svg v-if="item?.icon" class="size-6 text-paragraph group-hover:text-primary" fill="none" viewBox="0 0 24 24"
        ...
        <div class="flex-auto">
            <NuxtLink :to="item.hash" @click.native="emit('closeDropdown', true)" :class="['block font-semibold font-poppins',
