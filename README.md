...
│
├── components/                 # Componentes Vue (22 archivos)
│   ├── Header/
...
│   │       └── Stats.vue
│   ├── Slider/
│   │   ├── HomeCards.vue       # Carrusel de cards (home)
│   │   ├── HomeLogos.vue       # Carrusel de logos de clientes
│   │   └── HomeStats.vue       # Carrusel de estadísticas
...
│   ├── Logo.vue                # Logo de ConCentra (SVG)
...
│   ├── clientes.vue            # Directorio de clientes
...
│       └── empleo.vue          # Formulario de empleo
│
...
│   ├── Animation-*.json        # Animaciones Lottie
│   └── WhatsApp.svg
│
├── server/                     # Server-side code
│   └── api/
│       └── directus/           # API routes para Directus
│           ├── init.post.js    # Carga inicial de datos
